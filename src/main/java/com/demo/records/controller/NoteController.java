...
//        log.info("/report/download/md: id="+id);
    ...
    public Result getAllTypes() {
        return new Result(noteService.getAllTypes());
    }

    @ResponseBody
    @GetMapping("/getAllTags")
    public Result getAllTags() {
        return new Result(noteService.getAllTags());
    }

    @ResponseBody
    @PostMapping("/query")
    public Result query(@RequestBody NoteQueryReq req) {
        List<NoteDO> list = noteService.query(req);
        return  new Result(list);
    }
}